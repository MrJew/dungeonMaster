...
ap.save()
bs = Formula(name="Big Sword",formula="agi 2 / str +")
bs.save()
ss = Formula(name="Short Sword",formula="dex 2 / agi +")
ss.save()
bw = Formula(name="Bow",formula="agi 2 / dex +")
bw.save()
...
a2.save()
w1 = Item(name="sword",type="Sword",dmg=3,weight=4,ap=5,attack=ss)
w1.save()
w2 = Item(name="bow",type="Bow",dmg=3,weight=4,ap=7,attack=bw)
w2.save()
